        ...
        {isAuthenticated ? (
          <div className="relative">
            <button
              ...
              className="
                flex items-center gap-2 text-white hover:opacity-80 
                transition-opacity duration-200 bg-transparent border-none cursor-pointer
              "
            >
                ...
                <div className="border-t border-gray-200 mt-2">
                  <button
                    ...
                    className="
                      ...
                      hover:bg-gray-100 bg-transparent border-none cursor-pointer
                    "
                  >
                    🚪 Odjavi se
                  </button>
